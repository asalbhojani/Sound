        ...
        <div class="row">
            <div class="login-form">
                <form  method="post" class="text-left"  enctype="multipart/form-data">
                    <h3 style="color: var(--theme-primary-color);">Sign up</h3>

                    <p class="login-username pt-2">
                        <input type="text" name="name" id="user_name" class="input input_test" placeholder="Full name" autocomplete="off" required="">
                    </p>

                    <p class="login-username pt-2">
                        <input type="email" name="email" id="user_email" class="input input_test" placeholder="Email ID" autocomplete="off" required="">
                    </p>
...
<div class="img-extension mt-3">
  <div class="d-inline-block align-items-center">
     ...
     <span>allowed</span>
                    ...
                    <p class="login-username pt-2">
                        <input type="text" name="address" id="user_phone" class="input input_test" placeholder="Address" autocomplete="off" required="">
                    </p>
                    ...
                    <p class="login-password">
                        <input type="password" name="conpass" id="conf_user_pass" class="input input_test" placeholder="Confirm Password" autocomplete="off" required="">
                    </p>

                    <br>
                    <span class="mt-3">By signing up,you agree to our <a href="https://codeigniter.nemosofts.com/v1/tamilaudiopro/Terms" class="pb-page-link" style="color: var(--theme-primary-color);">Terms and Conditions</a> and <a href="https://codeigniter.nemosofts.com/v1/tamilaudiopro/Privacy_Policy" class="pb-page-link" style="color: var(--theme-primary-color);">Privacy Policy</a></span>
                    <br>
                    <br>

                    <button type="submit" name="submit" class="btn btn-danger rounded-pill rounded-2 pb_login ">Register</button>
                   
                    <br>
                    <span class="mt-3">Already have an account? <a href="signin.php" class="pb-page-link" style="color: var(--theme-primary-color);">Login</a></span>
                </form>
            </div>
        </div>
                ...
                if (move_uploaded_file($tmploc, $destination)) {
                   include "connect.php";
                    ...
                    if($pass == $conpass){
                        ...
                        include "connect.php";
                        $ins = mysqli_query($con,"INSERT INTO `register`VALUES ('','$img','$name','$email','$address','$pass','InActive')");
                        ...
                        if($ins){
                         ...
                         echo '<script>alert("You are not registered !!! PASSWORDS DONT MATCH")</script>';
                     }
